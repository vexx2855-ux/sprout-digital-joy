...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Agrivio" },
      { name: "description", content: "We reply to every message — usually within a day." },
      { property: "og:title", content: "Contact Agrivio" },
      { property: "og:description", content: "Reach the Agrivio team. We answer within a day." },
    ],
  }),
  component: Contact,
});
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
          ...
          <div className="space-y-3">
            {[
              { i: Mail, t: "hello@agrivio.in", s: "Email us anytime" },
