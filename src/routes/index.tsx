  ...
  return (
    <section ref={ref} className="relative isolate overflow-hidden pt-16 pb-24 sm:pt-24 sm:pb-32">
      ...
      <motion.div style={{ y, opacity }} className="relative mx-auto max-w-5xl px-4 text-center sm:px-6">
        ...
        >
          Seedify turns discarded fruit seeds and farm residue into quality saplings,
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6">
      <SectionHeading
        ...
        description="Four things are broken in the loop between fruit markets and farms. Seedify closes them."
      />
...
function Pipeline() {
  const steps = [
    ...
    { n: "03", t: "Seedify marketplace", d: "Listed with weather, soil and season data." },
