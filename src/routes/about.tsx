...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About — Agrivio" },
      { property: "og:description", content: "Mission, vision and the story of how Agrivio began." },
    ],
  }),
  component: About,
});
    ...
    <>
      <section className="relative mx-auto max-w-5xl px-4 pt-24 pb-16 text-center sm:px-6">
        ...
        <h1 className="mt-6 font-display text-5xl font-bold tracking-tighter sm:text-7xl text-balance">
          Why we started <span className="text-shimmer">Agrivio.</span>
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-balance text-muted-foreground sm:text-lg">
          ...
          thrown away. Those seeds could become trees, food, shade and income. Agrivio is the
