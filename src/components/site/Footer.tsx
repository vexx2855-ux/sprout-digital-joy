            ...
            <div className="mt-5 flex gap-2">
              {[AtSign, Send, Mail].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="grid h-9 w-9 place-items-center rounded-full border border-black/10 bg-black/5 text-muted-foreground hover:text-primary hover:border-primary/40 transition"
                >
